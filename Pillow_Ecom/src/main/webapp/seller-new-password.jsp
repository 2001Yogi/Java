                    ...
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="SellerController" method="post" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="form-control" id="name" name="cnp" placeholder="Confirm New Password" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Confirm New Password'" >
                                </div>   
                                <div class="col-md-12 form-group">
                                    <button type="submit" value="new pass" name= "action" class="btn_3">
                                        Get OTP
                                    </button>
                                </div>
                            </form>
